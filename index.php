    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 - <?php echo $_SESSION['setting_name'] ?> | <a href="Rumah Sakit Malang" target="_blank"></a></div></div>
        </footer>
